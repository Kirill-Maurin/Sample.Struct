...
namespace Sample.Struct.Functions
{
        ...
        where T : IFunc<TIn, TOut>
    {
        ...
        public static implicit operator Function<T, TIn, TOut>(T value) => new Function<T, TIn, TOut>(value);
        ...
        where TOperator : ISummator<TOut, TOut>
    {
        ...
        public static implicit operator Function<T, TIn, TOut, TOperator>(T value) => new Function<T, TIn, TOut, TOperator>(value);
