...
public readonly ref struct Additive<T, TSummator> where TSummator : struct, ISummator<T>
{
    ...
    public static implicit operator Additive<T, TSummator>(T value) => new(value);
    ...
    where TSummator : struct, ISummator<TAccumulator, TIncrement>
{
    ...
    public static implicit operator Additive<TAccumulator, TIncrement, TSummator>(TAccumulator value) => new(value);
