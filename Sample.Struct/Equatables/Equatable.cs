...
{
    public static Equatable<int, IntComparer> AsEquatable(this int value) => new(value);
    ...
    public static Equatable<T, DefaultComparer<T>> AsDefaultEquatable<T>(this T value) => new(value);
    ...
    where TComparer : struct, IEqualityComparer<T>
{
    ...
    public static implicit operator Equatable<T, TComparer>(T value) => new(value);
}