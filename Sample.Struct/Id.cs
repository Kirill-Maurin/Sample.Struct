...
{
    public static Id<T, TKey> AsId<T, TKey>(this TKey id, T _) where T : IEntity<TKey> => new(id);

    public static Id<T, TKey> GetId<T, TKey>(this T entity) where T : IEntity<TKey> => new(entity.Id);
}
