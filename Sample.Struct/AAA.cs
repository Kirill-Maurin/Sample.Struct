...
{
    public static ArrangeResult<T> Arrange<T>(this T @object)
    {
        return new ArrangeResult<T>(@object);
    }
    ...
    {
        return new ActResult<TResult>(act(arrange.Object));
    }
    ...
    {
        internal ArrangeResult(T @object)
        {
            Object = @object;
        }
